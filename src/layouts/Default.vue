    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:l.toni2007@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.youtube.com/channel/UCxIsQ1mPmTyBweeEXtNFw2Q" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/toniel" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/tonilistiyo" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/tonilistiyo" target="_blank" class="text-white hover:text-gray-400">
