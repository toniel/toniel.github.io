  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16 mt-8">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Toni Listiyo's personal blog</div>
    ...
    <div class="overflow-x-hidden">
      ...
      <div class="projects container-inner mx-auto text-xl border-t border-gray-500 border-b py-16 mb-16 relative">
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          <li class="checkmark">
            <div>Grapindo Invoice</div>
            <div class="text-lg text-gray-600">Pembuatan aplikasi invoice untuk percetakan Grapindo (Tirto - Pekalongan)</div>
          </li>
          <li class="checkmark">
            <div><a href="https://ppid.batangkab.go.id/">PPID Kabupaten Batang</a></div>
            <div class="text-lg text-gray-600">Website keterbukaan informasi Pemerintah Kabupaten Batang. Website ini saya buat ketika saya bekerja di Dinas Komunikasi dan Informatika Kabupaten Batang</div>
          </li>
          <li class="checkmark">
            <div><a href="http://www.mmtrental.com/">Maju Mega Trans</a></div>
            <div class="text-lg text-gray-600">Website Company Profile PT. Maju Mega Trans yang bergerak di bidang penyewaan alat - alat berat.</div>
          </li>
          <li class="checkmark">
            <div><a href="https://sstindo.id/">SST Indo</a></div>
            <div class="text-lg text-gray-600">Website Company Profile untuk perusahaan PT. Surya Sakti Teknindo yang bergerak dalam bidang pabrikasi mesin, pengadaan, perdagangan sparepart alat berat, mesin dan penyewaan alat – alat proyek yang berlokasi di Gorontalo</div>
          </li>
          <li class="checkmark">
            <div><a href="https://www.557rent.com/">557rent.com</a></div>
            <div class="text-lg text-gray-600">Website yang sama untuk perusahaan PT. Surya Sakti Teknindo.</div>
          </li>
          <li class="checkmark">
            <div><a href="https://aits.co.id/">PT. Aviation Indonesia Travel Services (AITS)</a></div>
            <div class="text-lg text-gray-600">Website Company Profile PT. Aviation Indonesia Travel Services (AITS) yang bergerak dalam jasa travel</div>
          </li>
          <li class="checkmark">
            <div>Gyntrans</div>
            <div class="text-lg text-gray-600">Website Company Profile dan Manajemen transaksi expedisi pengiriman barang CV. Gyntrans (Gringsing - Batang)</div>
          </li>
          <li class="checkmark">
            <div>DPUTARU Kab. Pekalongan</div>
            <div class="text-lg text-gray-600">Website resmi Dinas Pekerjaan Umum dan Penataan Ruang Kab. Pekalongan</div>
          </li>
    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      ...
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          <div><g-image src="../../static/unnamed.png" alt="avatar" class="w-32 h-32 rounded-full mb-8 lg:mb-0" /></div>
          <div class="flex-1 text-lg sm:text-xl ml-6">I'm Toni Listiyo, web developer from Batang - Central Java - Indonesia. I help clients by creating systems for their business. I have more than 5 years of experience as a web developer, especially Laravel. I am currently working remotely as a web developer for a startup company in Cyber Jaya - Malaysia. </div>
        </div>
      ...
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <div class="text-lg sm:text-lg mb-16">
            <form  action="https://formspree.io/f/xdoybynn"
  method="POST" id="my-form" class="mb-12">
              <div class="flex flex-wrap mb-6 -mx-4">
                  <div class="w-full md:w-1/2 mb-6 md:mb-0 px-4">
                      ...
                      <input type="text" name="_name" id="name" placeholder="Jon Snow" class="block w-full bg-background-form border border-border-color-primary shadow rounded outline-none focus:border-green-700 mb-2 p-4" required>
                  </div>
